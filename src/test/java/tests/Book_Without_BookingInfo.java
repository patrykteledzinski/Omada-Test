...
public class Book_Without_BookingInfo {
    ...
    public void Test () {
        ...
        //Step 3. Type in "Name on card*"
        ExampleHotelPage.cardNameField.sendKeys(CardName);

        //Step 4. Type in "Card Number*"
        ExampleHotelPage.cardNumberField.sendKeys(CardNumber);

        //Step 5. Select  "Expiration Date*" Tip: Only future date should be valid
        //Month
        ...
        //Step 6. Type in "Security code*"
        ExampleHotelPage.securityCode.sendKeys(SecurityCode);

        //Step 7. Click on "Complete Booking" button
